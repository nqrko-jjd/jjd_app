...
async function main() {
  ...
  // (Ancien recalage du statut des chantiers xlsx sur `statusRaw` retiré : il s'exécutait à
  // chaque démarrage de l'API, donc à chaque déploiement, et écrasait tout statut modifié
  // dans l'appli — ex. les chantiers passés en « Clôturé » revenaient à « Facturé ».)
